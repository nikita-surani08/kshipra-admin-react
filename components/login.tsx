...
const Login = () => {
  ...
  const handleModeChange = (newMode: "login" | "forgot") => {
    setMode(newMode);
    setError("");
    setSuccessMessage("");
    if (newMode === "forgot") {
        ...
        {mode === "login" ? (
          <>
            ...
            <div className="-mt-4 flex flex-col items-center justify-center gap-4">
              ...
              <div className="relative text-green-600 text-center">{successMessage}</div>
            </div>
          </>
        ) : (
          <div className="flex flex-col w-[350px] items-center justify-center gap-4">
            <h1 className="text-4xl font-bold text-[#1E4640]">Forgot password?</h1>
            <p className="mt-2 text-base text-[#556B66] text-center leading-7">
            ...
            <button
              type="button"
              className="bg-[#1E4640] w-full text-white rounded-xl py-3 text-lg font-medium hover:bg-opacity-90 transition-colors"
            ...
            <button
              type="button"
              className="text-sm font-medium text-[#1E4640] hover:text-[#7DB4AB]"
